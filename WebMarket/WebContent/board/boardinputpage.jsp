...
<form action="boardinput.jsp" method="post"method="post" enctype="multipart/form-data">
   ...
   <div class="form-group row">
      <label class="col-sm-2">타이틀</label>
      <div class="col-sm-3">
         <input name="title" type="text" class="form-control" placeholder="타이틀을입력하세요">
      </div>
   </div>
   ...
   <div class="form-group row">
      ...
      <div class="col-sm-3">
         <input name="content" type="text" class="form-control" placeholder="전화번호를 입력하세요">
      </div>
   </div>
