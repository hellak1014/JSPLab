...
%>
	...
	<tr>
      <th class = "table-light" scope="row"><%=mno %></th>
      <td class = "table-danger"><%=mname %></td>
      <td class = "table-warning"><%=mtel %></td>
      <td class = "table-success"><%=mlevel %></td>
      <td class = "table-info"><%=mdate %></td>
    </tr>
