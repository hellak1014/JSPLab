...
<div class="divTable table">
	...
	<div class="divTableRow">
		<div class="col-4">#</div><div class="divTableCell">상세정보</div></div>
	<div class="divTableRow">
		<div class="col-4">게시글 번호</div><div class="divTableCell"><%=review.getRno() %></div></div>
	<div class="divTableRow">
		<div class="col-4">제목</div><div class="divTableCell"><%=review.getRtitle() %></div></div>
	<div class="divTableRow">
		<div class="col-4">작성자</div><div class="divTableCell"><%=review.getRname() %></div></div>
	<div class="divTableRow">
		<div class="col-4">스포일러 여부</div><div class="divTableCell"><%=review.getRspo() %></div></div>
	<div class="divTableRow">
		<div class="col-4">리뷰</div><div class="divTableCell"><%=review.getRcont() %></div></div>
</div>
</div>
