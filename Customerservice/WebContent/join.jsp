...
<main class="form-signin w-100 m-auto">
  ...
  <form action="joincheck.jsp" method="get">
    <img class="mb-4" src="https://mblogthumb-phinf.pstatic.net/20160512_297/gatoblancokr_1463028030970omGoS_JPEG/Siamese-cat-on-couch.jpg?type=w2" alt="" width="72" height="57">
    ...
    <div class="form-floating">
      <input type="text" name="pass" class="form-control" id="floatingPassword" placeholder="Password">
