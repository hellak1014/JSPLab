...
<form action="memberinput.jsp" method="post" enctype="multipart/form-data">
	...
	<div class="form-group row">
		...
		<div class="col-sm-3">
			<input name="mid" type="text" class="form-control" placeholder="카카오 계정에서 사용하는 이름을 적어주세요">
		</div>
	</div>
	...
	<div class="container" style="height:10px;"></div>
		...
		<div class="col-sm-3">
			<input name="memail" type="text" class="form-control" placeholder="카카오 계정에서 사용하는 이메일을 적어주세요">
		</div>
	</div>
